...
SELECT order_id, shipped_date, order_date, shipped_date - order_date as day_differense FROM orders
...
SELECT COUNT(DISTINCT ship_country) as count_country FROM orders