...
JOIN employees as employees USING(employee_id)
JOIN shippers as shippers ON orders.ship_via = shippers.shipper_id
...
WHERE EXISTS(SELECT * FROM order_details WHERE products.product_id=order_details.product_id AND order_details.quantity IN(10))
